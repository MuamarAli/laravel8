    ...
    <div>
        ...
        <form action="{{ route('article.store') }}" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="published_at" placeholder="Publish date" value="{{ old('published_at') }}"/>
                    @error('published_at')
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control wysiwyg" name="content" placeholder="Content"></textarea>
                    @error('content')
